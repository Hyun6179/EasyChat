                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (otherUserModel != null) {
                            ...
                            if (model.getLastMessageTimestamp() != null) {
                                Timestamp timestamp = (Timestamp) model.getLastMessageTimestamp();
                                String timestampStr = FirebaseUtil.timestampToString(timestamp);
                                holder.lastMessageTime.setText(timestampStr);
                            } else {
